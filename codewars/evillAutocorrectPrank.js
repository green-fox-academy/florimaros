...
//AlgorithmsStringsRegular ExpressionsDeclarative Programmin

function autocorrect(input){
  var output = "";
  var selectedWords= input.split(" ")
  console.log(selectedWords)
  for(var i=0; i<selectedWords.length; i++) {
    if(selectedWords[i]==="u" || selectedWords[i]==="you") {
    selectedWords[i]="your sister";
    }
  }
  for(var i=0; i<selectedWords.length; i++) {
  output+=selectedWords[i]+" ";
  }  return output;
}
console.log(autocorrect("u u2 you for four"));
