...
class TestFunc(unittest.TestCase):
    ...
    def setUp(self):
        self._c1 = pld4.Character(health=10, armor=5)
        self._c2 = pld4.Character(health=50, armor=30)
